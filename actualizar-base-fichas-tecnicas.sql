...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909184007_AgregarFichasTecnicas') THEN
    CREATE TABLE ficha_tecnica (
        id uuid NOT NULL,
        codigo character varying(80) NOT NULL,
        categoria character varying(150) NOT NULL,
        linea character varying(150) NOT NULL,
        estado character varying(20) NOT NULL,
        imagen_datos bytea,
        imagen_tipo_contenido character varying(100),
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909184007_AgregarFichasTecnicas') THEN
    CREATE TABLE ficha_tecnica_atributo (
        id uuid NOT NULL,
        ficha_tecnica_id uuid NOT NULL,
        atributo character varying(100) NOT NULL,
        valor character varying(500) NOT NULL,
        observacion character varying(500),
        CONSTRAINT "PK_ficha_tecnica_atributo" PRIMARY KEY (id),
        CONSTRAINT "FK_ficha_tecnica_atributo_ficha_tecnica_ficha_tecnica_id" FOREIGN KEY (ficha_tecnica_id) REFERENCES ficha_tecnica (id) ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909184007_AgregarFichasTecnicas') THEN
    CREATE UNIQUE INDEX "IX_ficha_tecnica_codigo" ON ficha_tecnica (codigo);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909184007_AgregarFichasTecnicas') THEN
    CREATE UNIQUE INDEX "IX_ficha_tecnica_atributo_ficha_tecnica_id_atributo" ON ficha_tecnica_atributo (ficha_tecnica_id, atributo);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909184007_AgregarFichasTecnicas') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909184007_AgregarFichasTecnicas', '10.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909210444_AgregarReferenciaFichaTecnica') THEN
    ALTER TABLE ficha_tecnica ADD referencia character varying(100) NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909210444_AgregarReferenciaFichaTecnica') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909210444_AgregarReferenciaFichaTecnica', '10.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909211240_AgregarDetallesTecnicosFicha') THEN
    ALTER TABLE ficha_tecnica ADD color_para_fabricar character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909211240_AgregarDetallesTecnicosFicha') THEN
    ALTER TABLE ficha_tecnica ADD composicion_tela character varying(255);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909211240_AgregarDetallesTecnicosFicha') THEN
    ALTER TABLE ficha_tecnica ADD curva_talla character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909211240_AgregarDetallesTecnicosFicha') THEN
    ALTER TABLE ficha_tecnica ADD marca_producto character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909211240_AgregarDetallesTecnicosFicha') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909211240_AgregarDetallesTecnicosFicha', '10.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909212701_AgregarDetallesAtributoFicha') THEN
    ALTER TABLE ficha_tecnica_atributo ADD color_para_fabricar character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909212701_AgregarDetallesAtributoFicha') THEN
    ALTER TABLE ficha_tecnica_atributo ADD composicion_tela character varying(255);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909212701_AgregarDetallesAtributoFicha') THEN
    ALTER TABLE ficha_tecnica_atributo ADD curva_talla character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909212701_AgregarDetallesAtributoFicha') THEN
    ALTER TABLE ficha_tecnica_atributo ADD marca_producto character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260909212701_AgregarDetallesAtributoFicha') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260909212701_AgregarDetallesAtributoFicha', '10.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260910124445_HacerUnicaReferenciaFichaTecnica') THEN
    CREATE UNIQUE INDEX "IX_ficha_tecnica_referencia" ON ficha_tecnica (referencia);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260910124445_HacerUnicaReferenciaFichaTecnica') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260910124445_HacerUnicaReferenciaFichaTecnica', '10.0.0');
    END IF;
END $EF$;
COMMIT;
