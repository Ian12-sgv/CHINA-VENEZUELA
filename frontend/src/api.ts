...
export const pedidosApi = {
  ...
  duplicarProducto: (id: string, data: DuplicarProductoPedidoRequest) => request<ProductoPedido>(`/pedidos/productos/${id}/duplicar`, { method: 'POST', body: JSON.stringify(data) }),
