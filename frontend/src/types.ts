...
export type ProductoPedido = { id: string; pedidoId: string | null; grupoPedidoNombre: string | null; codigoBarraAsignado: string; precioRmb: number | null; totalRmb: number | null; cantidadDoz: number | null; referenciaAsignada: string; tipoProducto: 'Nuevo' | 'Repetido' | null; agente: string | null; fabrica: string | null; composicionTela: string | null; colorParaFabricar: string | null; marcaProducto: string | null; curvaTalla: string | null; packPorCaja: number | null; cantidadUnidades: number | null; marcaBulto: string | null; cantidadBulto: number | null; fechaRegistroPedido: string; fechaInicioFabricacion: string | null; activo: boolean; enviado: boolean; fechaEnvioUtc: string | null; tieneImagenFabrica: boolean; tieneImagenProductoTerminado: boolean; creadoPorCodigoUsuario: string; fechaCreacionUtc: string }
