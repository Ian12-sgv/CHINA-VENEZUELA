...
public sealed record BultoProductoPedidoRequest(Guid MarcaBultoId, int Cantidad);
public sealed record BultoProductoPedidoResponse(Guid MarcaBultoId, string Nombre, int Cantidad);
public sealed record CrearProductoPedidoRequest(Guid? PedidoId, string? NombreNuevoGrupo, string CodigoBarraAsignado, decimal? PrecioRmb, decimal? TotalRmb, int? CantidadDoz, string ReferenciaAsignada, string? TipoProducto, string? Agente, string? Fabrica, string? ComposicionTela, string? ColorParaFabricar, string? MarcaProducto, string? CurvaTalla, int? PackPorCaja, int? CantidadUnidades, IReadOnlyList<BultoProductoPedidoRequest> Bultos, DateOnly FechaRegistroPedido, DateOnly? FechaInicioFabricacion);
public sealed record ActualizarProductoPedidoRequest(Guid? PedidoId, string? NombreNuevoGrupo, string CodigoBarraAsignado, decimal? PrecioRmb, decimal? TotalRmb, int? CantidadDoz, string ReferenciaAsignada, string? TipoProducto, string? Agente, string? Fabrica, string? ComposicionTela, string? ColorParaFabricar, string? MarcaProducto, string? CurvaTalla, int? PackPorCaja, int? CantidadUnidades, IReadOnlyList<BultoProductoPedidoRequest> Bultos, DateOnly FechaRegistroPedido, DateOnly? FechaInicioFabricacion);
