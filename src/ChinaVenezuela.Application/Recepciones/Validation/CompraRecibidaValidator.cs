...
{
    public static void Validate(CrearCompraRecibidaRequest request) => ValidateCore(request.NombreContenedor, request.NumeroContenedor, request.EmpresaId, request.Descripcion, request.FechaSalida, request.FechaLlegada, request.Aduana, request.PuertoLlegada);
    public static void Validate(ActualizarCompraRecibidaRequest request) => ValidateCore(request.NombreContenedor, request.NumeroContenedor, request.EmpresaId, request.Descripcion, request.FechaSalida, request.FechaLlegada, request.Aduana, request.PuertoLlegada);

    private static void ValidateCore(string nombreContenedor, string numeroContenedor, Guid empresaId, string? descripcion, DateOnly fechaSalida, DateOnly? fechaLlegada, string? aduana, string puertoLlegada)
    {
